static mut GIVEN: *mut dlpark::DLManagedTensor = std::ptr::null_mut();

fn display(managed_tensor: &dlpark::DLManagedTensor) {
...
#[no_mangle]
unsafe extern "C" fn give(managed_tensor: dlpark::DLManagedTensor) {
